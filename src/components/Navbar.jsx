                ...
                <nav className="bg-white float-left border-gray-200 dark:bg-gray-900 w-full">
                    <div className='container mx-auto'>
                        <div className="max-w-screen-xl moible-full flex flex-wrap items-center mx-auto p-4">
                            <NavLink to='/' className="navLink font-extrabold flex loggos items-center space-x-3 rtl:space-x-reverse">
                                <img src='/logo.png' className="logo-ps" alt='logo' width={100} />
                            </NavLink>
                            ...
                            <div className={`fixed top-0 offcanv left-0 w-64 h-full bg-white dark:bg-gray-900 shadow-lg z-50 transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full'
                                }`} >
